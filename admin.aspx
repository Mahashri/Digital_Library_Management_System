...
<header>
		...
		<div class="middle-w3ls-nav py-2">
			<div class="container">
					...
					<a class="logo font-italic font-weight-bold col-lg-4 text-lg-left text-center" href="#">BCA DIGITAL LIBRARY</a>
	...
	<div class="about-page py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-dark text-center mb-5">Admin Login
              ...
              <tr>
                  <td class="style3">
                      Password</td>
                  <td class="style3">
                      <asp:TextBox ID="TextBox2" runat="server" TextMode="Password" Height="33px" Width="191px" required=""></asp:TextBox>
                  </td>
              </tr>
              <tr>
                  <td>
